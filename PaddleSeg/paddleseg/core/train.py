...
def train(model,
    ...
    if len(train_loss)>0:
        ...
        # plt.plot(range(0,len(train_loss[::10]),1), train_loss[::10])
        # plt.savefig(os.path.join(save_dir,"loss_10.png"))

        # plt.plot(range(0,len(train_loss[::100]),1), train_loss[::100])
        # plt.savefig(os.path.join(save_dir,"loss_100.png"))

        # plt.plot(range(0,len(train_loss[::200]),1), train_loss[::200])
        # plt.savefig(os.path.join(save_dir,"loss_200.png"))

        # plt.plot(range(0,len(train_loss[::300]),1), train_loss[::300])
        # plt.savefig(os.path.join(save_dir,"loss_300.png"))

        # plt.plot(range(0,len(train_loss)[::500],1), train_loss[::500])
        # plt.savefig(os.path.join(save_dir,"loss_500.png"))
