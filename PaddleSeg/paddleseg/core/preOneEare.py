...
def preOneEare(model,
            ...
            custom_color=None):
    """
    preOneEare and visualize the image_list.

    Args:
        model (nn.Layer): Used to preOneEare for input image.
        model_path (str): The path of pretrained model.
        transforms (transform.Compose): Preprocess for input image.
        image_list (list): A list of image path to be preOneEare.
        image_dir (str, optional): The root directory of the images preOneEare. Default: None.
        ...
        is_slide (bool, optional): Whether to preOneEare by sliding window. Default: False.
    ...
    logger.info("Start to preOneEare...")
